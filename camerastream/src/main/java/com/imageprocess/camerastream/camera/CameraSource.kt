...
private constructor() {
    ...
    private var mPreviewInterface: PreviewInterface? = null
     ...
     */(
        ...
        init {
            ...
            mCameraSource.mPreviewInterface = previewInterface;
        }
...
//        }
    ...
    private inner class CameraPreviewCallback : Camera.PreviewCallback {
        override fun onPreviewFrame(data: ByteArray, camera: Camera) {
            mPreviewInterface?.onGetCameraPreview(data, previewSize)
